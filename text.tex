...
\\
\\
L'estimation des paramètres sont calculées par l'algorithme de Nelder-Mead (voir annexe). On peut pousser l'estimation des paramètres notamment $\gamma$ via la méthode de Pickands afin de se convaincre du signe de $\gamma$.
\begin{center}
...
On applique la même méthode sur les données de sinistres. On choisit des blocs de taille 12, ce qui nous donne 10 blocs de 12 mois.
...
\\
\\
On obtenut dand la méthode des maxima en bloc une valeur de $\gamma$ postive mais proche de 0,
