...
L'estimation numériques par l'algorithme de Nelder-Mead des paramètres $a_n$,$b_n$ et $\gamma$ nous donne :
\[
a_n = 36.02, \quad b_n = 18.82, \quad \gamma = -0.5
\]
...
\begin{center}
	\includegraphics[scale=0.8]{./images/wooster.png} 
\end{center}

\subsection{Deuxieme méthode (Méthode de depassement de seuil) avec Rain}
