...
\\
\\
On suppose alors que $\gamma > 0$, donc il n’existe pas de valeur maximale finie : la probabilité de très gros maxima décroît lentement, selon un comportement polynomial plutôt que exponentiel ce qui est embettant dans le cas pratique.
\\
\\
\\
