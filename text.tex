...
\]
\[
\text{Ce qui donne,} \; \; n(1 - F(a_n t + b_n)) \xrightarrow[n\to +\infty]{} - \ln (G(t))
\]
Où on a utilisé le développement limité de la fonction logarithme. 
\\
\\
...
\vspace{0.3cm}
\noindent
Nous avons alors la proposition suivante (\textit{Statistics of Extremes, Jan Beirlant 2004}) :
