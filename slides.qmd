...
- Etudier des événements  : crues, canicules, krachs boursiers
...
L'idée est de prendre deux suites $(a_n)$ et $(b_n)$ avec $a_n>0$ pour tout $n$, et alors on a, sous de bonnes conditions : 
$$
